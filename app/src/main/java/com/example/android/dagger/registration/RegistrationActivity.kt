...
class RegistrationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //When using Activities call inject before super.onCreate (which one can attach
        //fragments that might want to access activity bindings, so in this way we
        //can avoid issues with fragment restoration
